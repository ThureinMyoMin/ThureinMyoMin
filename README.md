...
<div style="width: 39rem; display:flex; padding-top: 15px; justify-content: center; background: white;gap: 10px; border-radius: 5px"> 
...
<div style="width:21.4rem; display:flex; justify-content: center; padding-top: 15px; gap: 10px; border-radius: 5px; background: white;"> 
